...
data_name_list = [r'Heuristic',r'Proposed',r'Ideal',r'ADMM']
...
for a in [0]:
    file_name_list = ["mgain","mmw","ideal","admm"]
    for tt in range(len(file_name_list)):
        ...
        for ss in range(11):
            ...
            data_file = os.path.join(current_dir, "sim_mmw_online_cmp_methods","sim_mmw_online_cmp_methods-2025-June-24-14-56-27-ail",fname)
