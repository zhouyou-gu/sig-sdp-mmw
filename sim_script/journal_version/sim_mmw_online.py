    ...
    for nit in [75,150,300]:
        for seed in range(REPEAT):
            ...
            for i in range(10):
                ...
                log.log_mul_scalar(data_name="online-"+str(i)+"-"+str(nit)+"-"+str(CELL_SIZE)+"-"+str(int(RHO*10000)),iteration=seed,values=bler.tolist())
                e.step_time(tim,mob_spd_meter_s=0.2)
