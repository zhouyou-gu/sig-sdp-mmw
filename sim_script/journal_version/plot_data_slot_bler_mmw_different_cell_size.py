...
data_name_list = [r'$l=100$m',r'$l=200$m',"$l=300$m"]
file_name_list = ["mmw150-5-75","mmw150-10-75","mmw150-15-75"]
...
for a in [0]:
    for ss in range(len(file_name_list)):
        s = file_name_list[ss]
        fname = s
        data_file = os.path.join(current_dir, "sim_mmw_bler_different_cell_size","sim_mmw_bler_different_cell_size-2024-July-26-03-22-31-ail",fname)
