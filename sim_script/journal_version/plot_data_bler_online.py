...
data_name_list = [r'Heuristic',r'Proposed',r'Ideal']
...
for a in [0]:
    file_name_list = ["mgain","mmw","ideal"]
    for tt in range(len(file_name_list)):
        ...
        for ss in range(11):
            ...
            data_file = os.path.join(current_dir, "sim_mmw_online","sim_mmw_online-2024-July-28-16-46-38-ail",fname)
...
# Add a legend
fig.legend(bars[0:len(data_name_list)], data_name_list ,fontsize=FONT_SIZE, loc='lower left', bbox_to_anchor=(0.2, 0.835, 0.775, 0.3), mode="expand",ncol = 3 ,borderaxespad=0.1,handlelength=1.5, handleheight= 1)
